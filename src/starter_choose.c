...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_TOGEPI)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_TOGEPI)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_TOGEPI )
